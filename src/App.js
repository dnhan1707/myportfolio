            ...
            <div className='h-1/2'>
              ...
              <div className='project-item flex flex-col mb-5'>
                ...
                <div className='project-1-des flex flex-row pt-5'>
                  <div className='pl-5'>
                    <h1 className="text-3xl text-white font-bold pt-1">TaskFlow AI</h1>
                    <p className='text-sm text-gray-500'>JavaScript, React, Firebase, GPT-4o</p>
                    <h1 className='pt-5 text-white'>TaskFlow AI is an innovative task management application designed to streamline project workflows and enhance team collaboration.</h1>
                  </div>
                </div>
              </div>
            </div>
