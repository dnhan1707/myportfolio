    ...
    return (
        <div className="w-full bg-black text-white">
            <div className="demo-container pb-20">
                <div className="journeyai-intro px-4 md:px-40">
                    ...
                    <h1>-{'> '}Is it live? Yes, it is. Click <span className="highlight hover:text-blue-500 hover:underline transition duration-300"><a href="journey-ai.dev" >here</a></span></h1>
                    <h1 className="pb-5">-{'> '}Try the <span className="highlight">demo</span> below here, start with the Login</h1>
                    <div className="px-4 md:px-20 py-20" style={{ position: 'relative', paddingBottom: 'calc(50.520833333333336% + 41px)', height: 0, width: '100%' }}>
                        <iframe 
                ...
                <div className="live-section text-white w-screen bg-black p-10 md:p-20 border-t border-t-slate-300 flex flex-col md:flex-row">
                    ...
                    <div className='small-des text-lg md:text-xl w-full md:w-1/3 flex flex-col justify-center p-5 md:p-10 slide-in-left'>
                        <div className='des pt-10 md:pt-20'>
                            ...
                            <p className='pt-5'>
                                219 is a small number but it is a <span className='highlight'>big milestone for me</span>. 
